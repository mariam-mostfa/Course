...
# pd.to_datetime بتحولي اي داتا تايب لارقام
df["Date"] = pd.to_datetime(df["Date"])
# dt.month بتستخرج رقم الشهر من التاريخ
...
# random state النتائج ثابته ومتكرره انما من غيرها النتائج هتتغير مع كل تشغيل
